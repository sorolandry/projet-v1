            ...
            <div class="form1">
                ...
                <form id="formulaireInscription" action="index.php?page=inscription" method="POST"
                    ...
                    <div class="photoProfil">
                        <input type="file" id="photoProfil" name="url_image">
                    </div>

                    <div class="trans">
                        <div>
                            <label for="nomComplet">Nom et Prénom :</label>
                            <input type="text" id="nomComplet" name="nom_complet"
                                placeholder="Entrez votre nom et prénom" required>
                        </div>

                        <div>
                            <label for="contacts">Contacts :</label>
                            <input type="text" id="contacts" name="numero" placeholder="Entrez vos contacts" required>
                        </div>
                    </div>
                    <button type="button" id="getLocationBtn">Obtenir ma position</button>
                    ...
                    <div class="trans">
                        ...
                        <div>
                            ...
                            <input type="text" id="quartier" name="quartier" placeholder="Entrez votre quartier">
                        </div>
                    </div>
                    ...
                    <input type="password" id="motDePasse" name="mot_de_passe" placeholder="Entrez votre mot de passe"
                        required>
                    ...
                    <div class="get">
                        ...
                        <div class="radio"><input type="radio" id="typeArtisan" name="typeUtilisateur" value="artisan"
                                onclick="toggleChampsArtisan()"> Artisan</div>
                    </div>
                    ...
                    <div id="champsArtisan" style="display: none;">
                        <div class="trans">
                            <div>
                                ...
                                <select id="branche-activite" name="branche_d_activite" required>
                            ...
                            <div>
                                ...
                                <select id="corps-metier" name="specialite" required>
                                    ...
                                    <option value="fabrication-machines" class="metaux-constructions">Fabrication de
                                        Machines
                                    </option>
                                    ...
                                    <option value="reparation-mecanique" class="metaux-constructions">Réparation et
                                        Mécanique
                                    </option>
                                    <option value="petites-activites-transport" class="metaux-constructions">Petites
                                        Activités
                                        de
                                        Transport</option>
                                    <option value="installation-maintenance" class="metaux-constructions">
                                        ...
                                        et
                                        Maintenance</option>
                                    <option value="electromecanique" class="metaux-constructions">Électromécanique
                                    </option>
                                    ...
                                    <option value="fabrication-textile" class="textile-habillement">Fabrication de
                                        Fibres
                                        Textile
                                    </option>
                                    <option value="fabrication-vetements" class="textile-habillement">Fabrication de
                                        Vêtements
                                    </option>
                                    ...
                                    <option value="coiffure-esthetique" class="hygiene-soins">Coiffure et Esthétique
                                    </option>
                                    <option value="fabrication-savons" class="hygiene-soins">Fabrication de Savons
                                    </option>
                                    ...
                                    <option value="nettoyage-entretien" class="hygiene-soins">Nettoyage et Entretien
                                    </option>
                                    <!-- Artisanat d'Art et Décoration Corps de Métiers -->
                                    <option value="joaillerie" class="artisanat-art">Joaillerie</option>
                                    <option value="art-traditionnel" class="artisanat-art">Art Traditionnel</option>
                                    <option value="restauration-patrimoine" class="artisanat-art">Restauration du
                                        Patrimoine
                                    </option>
                        ...
                        <div class="trans">
                            <div>
                                ...
                                <select id="metier" name="metier" required>
                                    ...
                                    <option value="transformateurs-fruits" class="alimentation">Transformateurs de
                                        fruits
                                    </option>
                                    <option value="conservateurs-fruits" class="alimentation">Conservateurs de
                                        fruits
                                    </option>
                                    <option value="transformateurs-legumes" class="alimentation">Transformateurs de
                                        légumes
                                    </option>
                                    ...
                                    <option value="conservateurs-noix" class="alimentation">Conservateurs de noix
                                    </option>
                                    <option value="transformateurs-feuilles" class="alimentation">Transformateurs de
                                        feuilles
                                    </option>
                                    ...
                                    <option value="transformateurs-grains" class="alimentation">Transformateurs de
                                        grains
                                    </option>
                                    <option value="transformateurs-tubercules" class="alimentation">Transformateurs
                                        de
                                        tubercules
                                    </option>
                                    <option value="fabricants-amylaces" class="alimentation">Fabricants de produits
                                        amylacés
                                    </option>
                                    ...
                                    <option value="fabricants-huiles-comestibles" class="alimentation">Fabricants
                                        d’huiles
                                        comestibles</option>
                                    <option value="bouchers" class="alimentation">Bouchers</option>
                                    <option value="charcutiers" class="alimentation">Charcutiers</option>
                                    <option value="transformateurs-viande" class="alimentation">Transformateurs de
                                        viande
                                    </option>
                                    <option value="conservateurs-viande" class="alimentation">Conservateurs de
                                        viande
                                    </option>
                                    <option value="transformateurs-volailles" class="alimentation">Transformateurs
                                        de
                                        volailles
                                    </option>
                                    <option value="conservateurs-volailles" class="alimentation">Conservateurs de
                                        volailles
                                    </option>
                                    <option value="preparateurs-viande" class="alimentation">Préparateurs de
                                        ...
                                        base de
                                        viande</option>
                                    <option value="transformateurs-poissons" class="alimentation">Transformateurs de
                                        poissons
                                    </option>
                                    <option value="conservateurs-poissons" class="alimentation">Conservateurs de
                                        poissons
                                    </option>
                                    <option value="transformateurs-crustaces" class="alimentation">Transformateurs
                                        de
                                        crustacés
                                    </option>
                                    <option value="conservateurs-crustaces" class="alimentation">Conservateurs de
                                        crustacés
                                    </option>
                                    <option value="transformateurs-mollusques" class="alimentation">Transformateurs
                                        de
                                        mollusques
                                    </option>
                                    <option value="conservateurs-mollusques" class="alimentation">Conservateurs de
                                        mollusques
                                    </option>
                                    <option value="fabricants-produits-laitiers" class="alimentation">Fabricants de
                                        produits
                                        laitiers</option>
                                    <option value="fabricants-glaces-alimentaires" class="alimentation">Fabricants
                                        de
                                        glaces
                                        alimentaires</option>
                                    <option value="fabricants-beurre" class="alimentation">Fabricants de beurre
                                    </option>
                                    <option value="fabricants-fromage" class="alimentation">Fabricants de fromage
                                    </option>
                                    <option value="fabricants-beurre-karite" class="alimentation">Fabricants de
                                        beurre
                                        de karité
                                    </option>
                                    <option value="fabricants-boissons" class="alimentation">Fabricants de boissons
                                        artisanales
                                    </option>
                                    ...
                                    <option value="fabricants-friandises" class="alimentation">Fabricants de
                                        ...
                                        à base
                                        d’arachide</option>
                                    <option value="fabricants-friandises-sucre" class="alimentation">Fabricants de
                                        friandises à
                                        base
                                        de sucre caramélé</option>
                                    <option value="fabricants-friandises-miel" class="alimentation">Fabricants de
                                        friandises à
                                        base
                                        de miel</option>
                                    <option value="fabricants-pates-alimentaires" class="alimentation">Fabricants de
                                        pâtes
                                        alimentaires</option>
                                    <option value="petits-restaurateurs" class="alimentation">Petits restaurateurs
                                    </option>
                                    ...
                                    <option value="extracteurs-pierres" class="extraction">Extracteurs de pierres
                                    </option>
                                    ...
                                    <option value="specialistes-forage" class="extraction">Spécialistes d’activités
                                        de
                                        forage
                                    </option>
                                    ...
                                    <option value="constructeurs-cases" class="construction">Constructeurs de cases
                                    </option>
                                    <option value="constructeurs-ouvrages-art" class="construction">Constructeurs
                                        d’ouvrages
                                        d’art
                                    </option>
                                    ...
                                    <option value="decorateurs-staffeurs" class="construction">Décorateurs-staffeurs
                                    </option>
                                    <option value="peintres" class="construction">Peintres</option>
                                    <option value="electriciens-batiment" class="construction">Électriciens bâtiment
                                    </option>
                                    <option value="dessinateurs-batiment" class="construction">Dessinateurs bâtiment
                                    </option>
                                    ...
                                    <option value="reparateurs-cycles" class="reparation-mecanique">Réparateurs de
                                        cycles
                                    </option>
                                    <option value="reparateurs-motocycles" class="reparation-mecanique">Réparateurs
                                        de
                                        motocycles
                                    </option>
                                    <option value="reparateurs-vehicules" class="reparation-mecanique">Réparateurs
                                        de
                                        véhicules
                                        automobiles</option>
                                    ...
                                    <option value="conducteurs-taxi" class="petites-activites-transport">Conducteurs
                                        de
                                        taxi
                                    </option>
                                    <option value="autres-conducteurs" class="petites-activites-transport">Autres
                                        conducteurs
                                    </option>
                                    ...
                                    <option value="mecaniciens-precision" class="electromecanique">Mécaniciens de
                                        précision
                                    </option>
                                    <option value="reparateurs-electromenager" class="electromecanique">Réparateurs
                                        d’appareils
                                        électroménagers</option>
                                    <option value="reparateurs-radio" class="electromecanique">Réparateurs de radio
                                    </option>
                                    <option value="reparateurs-television" class="electromecanique">Réparateurs de
                                        télévision
                                    </option>
                                    ...
                                    <option value="fabrication-meubles" class="travail-bois">Fabrication de meubles
                                    </option>
                                    ...
                                    <option value="fabrication-ouvrages-vannerie" class="travail-bois">Fabrication
                                        d’ouvrages en
                                        vannerie</option>
                                    ...
                                    <option value="fabrication-papier" class="travail-bois">Fabrication de papier
                                    </option>
                                    <option value="fabrication-carton" class="travail-bois">Fabrication de carton
                                    </option>
                                    <option value="fabrication-cartonnage" class="travail-bois">Fabrication de
                                        cartonnage
                                    </option>
                                    <option value="fabrication-emballages-papier" class="travail-bois">Fabrication
                                        d’emballages
                                        en
                                        papier</option>
                                    <option value="fabrication-emballages-carton" class="travail-bois">Fabrication
                                        d’emballages
                                        en
                                        carton</option>
                                    ...
                                    <option value="planteurs-fleurs" class="travail-vegetaux">Planteurs de fleurs
                                    </option>
                                    <!-- Textile et Habillement Métiers -->
                                    <option value="fabrication-fibres" class="fabrication-textile">Fabrication de
                                        fibres
                                    </option>
                                    <option value="fabrication-fils" class="fabrication-textile">Fabrication de fils
                                    </option>
                                    <option value="fabrication-tissus" class="fabrication-textile">Fabrication de
                                        tissus
                                    </option>
                                    <option value="fabrication-etoffes" class="fabrication-textile">Fabrication
                                        d’étoffes
                                    </option>
                                    <option value="fabrication-tricots" class="fabrication-textile">Fabrication de
                                        tricots
                                    </option>
                                    <option value="fabrication-tresses" class="fabrication-textile">Fabrication de
                                        tresses
                                    </option>
                                    <option value="fabrication-cordes" class="fabrication-textile">Fabrication de
                                        cordes
                                    </option>
                                    <option value="fabrication-filets" class="fabrication-textile">Fabrication de
                                        filets
                                    </option>
                                    ...
                                    <option value="reparation-chaussures" class="fabrication-vetements">Réparation
                                        de
                                        chaussures
                                    </option>
                                    ...
                                    <option value="personnel-menage" class="nettoyage-entretien">Personnel de ménage
                                    </option>
                                    ...
                                    <option value="bijoutiers-joailliers" class="joaillerie">Bijoutiers-joailliers
                                    </option>
                                    ...
                                    <option value="tresseurs-fibres-vegetales" class="art-traditionnel">Tresseurs de
                                        fibres
                                        végétales</option>
                                    ...
                                    <option value="styliste-decoration" class="decoration">Styliste de décoration
                                    </option>
                            ...
                            <div>
                                ...
                                <input type="text" id="contactsw" name="numero_whatsapp"
                                    placeholder="Entrez votre contacts whatsapp" required>
                            </div>
